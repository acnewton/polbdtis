...
typedef struct slice_type {
    ...
    double        order_parameter[MAXSTATES],
                  mindist,
                  enmaxclust,
                  enmaxclustop,
                  energy;
...
extern void calculate_forces_nonoise( Slice * );
extern void propagate_bd( Slice * );
extern void propagate_bd_nonoise( Slice * );
extern int clusteranalysis(Slice *);
extern void find_minimum( Slice * );
extern void find_minimum_forinstate( Slice * );
extern int add_newstate(Slice *);
extern int check_stability(int );
...
extern void target_input();
extern void target_output();
...
//extern void terminate_block(Stats ***, Stats ***);
extern void terminate_block();
//extern void finalstat(Stats ***);
extern void finalstat();
//extern void printstat(Stats ***);
//extern void printstat(int);
...
extern void setup_truncatedicosahedron(Slice *);
extern void setup_dodecahedron(Slice *);
extern void setup_icosahedron(Slice *);
extern void setup_octahedron(Slice *);
extern void setup_cube(Slice *);
extern void setup_tetrahedron(Slice *);
